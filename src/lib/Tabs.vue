<template>
  <div class="gulu-tabs">
    <div class="gulu-tabs-nav" ref="container">
      <div class="gulu-tabs-nav-item" :class="{selected:t === selected}" @click="select(t)"
           v-for="(t,index) in titles" :ref="el=>{if(t===selected) selectedItem =el}" :key="index">
        {{ t }}
      </div>
...
export default {
  ...
  setup(props, context) {
    ...
    const select = (title: string) => {context.emit('update:selected', title);};// 通知外面修改
